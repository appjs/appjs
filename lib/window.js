...
var props = ['left', 'top', 'width', 'height', 'title', 'state', 'topmost', 'showChrome', 'resizable', 'opacity', 'alpha'];
...
Frame.prototype = FrameImpl.prototype = {
  ...
  openDevTools: function openDevTools(top, left, width, height){
    unwrap(this).openDevTools(top, left, width, height);
    return this;
  },
  closeDevTools: function closeDevTools(top, left, width, height){
    unwrap(this).closeDevTools(top, left, width, height);
    return this;
  }
};
