...
var user = {
  win32:  function(){ return { home: process.env.USERPROFILE, name: process.env.USERNAME } },
  linux:  function(){ return { home: process.env.HOME,        name: process.env.LOGNAME  } },
  darwin: function(){ return { home: process.env.HOME,        name: process.env.USER     } }
}[process.platform]();
